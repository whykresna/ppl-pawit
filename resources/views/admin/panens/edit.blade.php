...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.panen.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.panens.update", [$panen->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('lahan') ? 'is-invalid' : '' }}" name="lahan_id" id="lahan_id" required>
                    @foreach($lahans as $id => $lahan)
                        <option value="{{ $id }}" {{ ($panen->lahan ? $panen->lahan->id : old('lahan_id')) == $id ? 'selected' : '' }}>{{ $lahan }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_buah') ? 'is-invalid' : '' }}" type="number" name="jumlah_buah" id="jumlah_buah" value="{{ old('jumlah_buah', $panen->jumlah_buah) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bruto') ? 'is-invalid' : '' }}" type="number" name="bruto" id="bruto" value="{{ old('bruto', $panen->bruto) }}" step="1" required>
                @if($errors->has('bruto'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bruto') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tarra') ? 'is-invalid' : '' }}" type="number" name="tarra" id="tarra" value="{{ old('tarra', $panen->tarra) }}" step="1" required>
                @if($errors->has('tarra'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tarra') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gross') ? 'is-invalid' : '' }}" type="number" name="gross" id="gross" value="{{ old('gross', $panen->gross) }}" step="1" required>
                @if($errors->has('gross'))
                    <div class="invalid-feedback">
                        {{ $errors->first('gross') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pot') ? 'is-invalid' : '' }}" type="number" name="pot" id="pot" value="{{ old('pot', $panen->pot) }}" step="1" required>
                @if($errors->has('pot'))
                    <div class="invalid-feedback">
                        {{ $errors->first('pot') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('netto') ? 'is-invalid' : '' }}" type="number" name="netto" id="netto" value="{{ old('netto', $panen->netto) }}" step="1" required>
                @if($errors->has('netto'))
                    <div class="invalid-feedback">
                        {{ $errors->first('netto') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keterangan') ? 'is-invalid' : '' }}" type="text" name="keterangan" id="keterangan" value="{{ old('keterangan', $panen->keterangan) }}">
