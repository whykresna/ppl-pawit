...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tengkulak.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tengkulaks.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="tanggal_masuk">{{ trans('cruds.tengkulak.fields.tanggal_masuk') }}</label>
                <input class="form-control datetime {{ $errors->has('tanggal_masuk') ? 'is-invalid' : '' }}" type="text" name="tanggal_masuk" id="tanggal_masuk" value="{{ old('tanggal_masuk') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_tengkulak') ? 'is-invalid' : '' }}" type="text" name="nama_tengkulak" id="nama_tengkulak" value="{{ old('nama_tengkulak', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamat_tengkulak') ? 'is-invalid' : '' }}" name="alamat_tengkulak" id="alamat_tengkulak" required>{{ old('alamat_tengkulak') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_telepon_tengkulak') ? 'is-invalid' : '' }}" type="text" name="nomor_telepon_tengkulak" id="nomor_telepon_tengkulak" value="{{ old('nomor_telepon_tengkulak', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_tengkulak') ? 'is-invalid' : '' }}" type="text" name="email_tengkulak" id="email_tengkulak" value="{{ old('email_tengkulak') }}" required>
