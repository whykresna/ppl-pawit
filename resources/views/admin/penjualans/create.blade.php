    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.penjualans.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tanggal_pengiriman') ? 'is-invalid' : '' }}" type="text" name="tanggal_pengiriman" id="tanggal_pengiriman" value="{{ old('tanggal_pengiriman') }}" required>
